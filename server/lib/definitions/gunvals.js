module.exports = {
// Bases
    basic: { reload: 50, recoil: 1.4, shudder: 0.1, damage: 0.75, speed: 5, spray: 15 },
    drone: { reload: 50, recoil: 0.25, shudder: 0.1, size: 0.6, speed: 1.5, spray: 0.1 },
    trap: { reload: 50, shudder: 0.25, size: 0.7, damage: 0.75, speed: 3.25, resist: 3, spray: 0 },
    swarm: { reload: 50, recoil: 0.25, shudder: 0.05, size: 0.4, damage: 0.75, speed: 4, spray: 5 },
...
// Drones
    ...
    sunchip: { reload: 4, size: 1.4, health: 100, damage: 10, pen: 0.6, density: 0.8 },
...
// Missiles
    launcher: { reload: 100, recoil: 1.5, shudder: 0.1, size: 0.72, health: 1.05, damage: 0.925, speed: 0.9, maxSpeed: 1.2, range: 1.1, resist: 1.5 },
